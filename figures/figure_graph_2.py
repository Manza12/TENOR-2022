...
fig.savefig('figure_graph_2.eps', bbox_inches='tight', pad_inches=0, transparent=True)
fig.savefig('figure_graph_2.png', bbox_inches='tight', pad_inches=0, transparent=True)
