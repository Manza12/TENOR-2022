...
nx.draw_networkx(graph, pos=pos, arrows=True, with_labels=True, labels=node_labels,
                 node_size=400*frame_size, node_color=color, font_size=12)
# nx.draw_networkx_edge_labels(graph, pos, edge_labels=edge_labels, font_size=10)

fig.savefig('figure_graph_4.eps', bbox_inches='tight', pad_inches=0, transparent=True)
fig.savefig('figure_graph_4.png', bbox_inches='tight', pad_inches=0, transparent=True)
