...
from graph import create_tree_polyphonic_full

timestamps = np.array([0., 0.55, 1.23, 1.77, 2.4])

# Graph
graph_acds, all_nodes = create_tree_polyphonic_full(timestamps, with_final_node=False, graph_width=3., graph_height=0.5)
...
plt.axis('off')
fig.savefig('Figure_2.eps', bbox_inches='tight', pad_inches=0, transparent=True)
plt.show()
